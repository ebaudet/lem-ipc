...
/*   Updated: 2019/11/07 14:53:01 by ebaudet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			print_tab(t_data *shared, t_player *pl);
...
void			move_height(t_pos enemy, t_player *p, t_data *shared
	, int t);
void			move_width(t_pos enemy, t_player *p, t_data *shared
	, int t);
void			get_sig(void);
